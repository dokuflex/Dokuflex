...
namespace DokuFlex.PowerPoint.AddIn
{
    ...
    public partial class Ribbon
    {
        private void Ribbon_Load(object sender, RibbonUIEventArgs e)
        {
            ...
            groupPresentation.Label = StringResources.PresentationText;
        ...
        {
            Globals.ThisAddIn.OpenPresentation();
        }

        private void btnSave_Click(object sender, RibbonControlEventArgs e)
        {
            Globals.ThisAddIn.SavePresentation();
        }
        ...
        private void btnRecents_Click(object sender, RibbonControlEventArgs e)
        {
            ...
            using (var form = new RecentsForm(ticket, ".ppt", 1))
            {
            ...
            Globals.ThisAddIn.OpenRecentPresentation(ticket, recent);
        }
        ...
        private void sbtnFavorites_Click(object sender, RibbonControlEventArgs e)
        {
            ...
            using (var form = new FavoritesForm(ticket, ".ppt", 1))
            {
                if (form.ShowDialog() == DialogResult.OK)
                {
                    recent = form.SelectedValue;
        ...
        private void btnFind_Click(object sender, RibbonControlEventArgs e)
        {
            ...
            using (var form = new SearchForm("ppt*", 1))
            {
                if (form.ShowDialog() == DialogResult.OK)
                {
            ...
            Globals.ThisAddIn.OpenRecentPresentation(ticket, result);
        }
    }
}

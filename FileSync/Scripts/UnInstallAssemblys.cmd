...
%regasm% "%installdir%\DokuFlex.FileSyncOverlayInSync.dll" /u

%regasm% "%installdir%\DokuFlex.FileSyncOverlaySyncInProgress.dll" /u

%regasm% "%installdir%\DokuFlex.FileSyncOverlayErrorConflict.dll" /u
